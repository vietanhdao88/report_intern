  ...
  <body>
    <div id="wrapper">
      ...
      <?php 
                ...
                $get_data = new data();
                $select = $get_data ->
          select_id('brands' , $_GET['update_brand']); foreach($select as
          $se) ?>
      <!-- /. NAV SIDE  -->
      <div id="page-wrapper">
        <div id="page-inner">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="panel panel-info">
                <div class="panel-heading">Cập nhật thương hiệu tại đây</div>
                <div class="panel-body">
                  <form role="form" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label> Name</label>
                      <input class="form-control" type="text" name="name" value="<?php echo $se['name'] ?>"/>
                    </div>
                   
                    <div class="form-group">
                      <label>Image</label>
                      <img src="../uploads/<?php echo $se['image'] ?>"  alt="">
               ...
               <?php   if(isset($_POST['btn-up'])){
                    ...
                    $update = $get_data ->
                  update_brand($_POST['name'], $picture, $_GET["update_brand"]);
                   if($update){
                    echo "<script>alert('Cập nhật thương hiệu thành công')
                    window.location ='list_brand.php'</script>";
                  }else{ echo "Cập nhật thương hiệu that bai"; }
                  } ?>
                </div>
              </div>
            </div>
