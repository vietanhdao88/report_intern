    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 class="page-head-line">Thêm sản phẩm</h1>
            </div>
          </div>
          <!-- /. ROW  -->
          <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="panel panel-info">
                <div class="panel-heading">Thêm sản phẩm tại đây</div>
                <div class="panel-body">
                  <form role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label>Colors</label>
                      <input class="form-control" type="number" name="color" style="width:50px"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="delivery" />
                    </div>
                    <div class="form-group">
                      <label>Amount</label>
                    ...
                    <button type="submit" class="btn btn-info" name="btn-add" style="background-color: #6A5AF9;padding: 12px 15px;border-radius: 10px;">
                      Add Product
                    </button>
                  </form>
                  <?php
                  ...
                  if(isset($_POST['btn-add'])){
                    ...
                    $insert = $get_data ->
                  insert_product($_POST['name'], $_POST['price']
                  ,$_FILES['thumnail']['name'] , $_POST['detail'] ,
                  $_POST['review'] , $_POST['delivery'] , $_POST['amount'] , $_POST['status'] , $_POST['title'] , $_POST['color'] , $_POST['price_sale'] );
                  if($insert){ 
                   echo "<script>alert('Thêm sản phẩm thành công')
                   window.location ='product.php'</script>";
                   }else{ echo
                  "them san pham that bai"; } } ?>
                </div>
              </div>
            </div>
          </div>
