      ...
      <div id="page-wrapper">
        <div id="page-inner">
          ...
          <?php 
                ...
                $get_data = new data();
                $select = $get_data ->
          select_id('products' , $_GET['update_product']); foreach($select as
          $se) ?>
          <!-- /. ROW  -->
          <div class="row">
                ...
                <div class="panel-body">
                  <form role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <img
                          src="../uploads/<?php echo $se['thumnail']?>"
                          alt=""
                    ...
                    <div class="form-group">
                      ...
                      <input
                        ...
                        type="number"
                        name="amount"
                        value="<?php echo $se['amount'] ?>"
                      />
                    </div>
                    <div class="form-group">
                    <label>Status</label>
                        <select class="form-control" name="status">
                        <option value="<?php echo $se['status'] ?>"><?php echo $se['status'] ?></option>
                    ...
                    <label>Title</label>
                      ...
                      <option value="<?php echo $se['title'] ?>"><?php echo $se['title'] ?></option>
                            <option value="50% off with code FALL50">50% off with code FALL50</option>
                            <option value="45% off with code FALL45">45% off with code FALL45</option>
                            <option value="60% off with code VANH50">60% off with code VANH50</option>
                        </select>
                    </div>
                  ...
                  if(isset($_POST['btn-up'])){
                    ...
                    if(empty($_FILES['thumnail']['name'])) {
                        ...
                        $picture= $_FILES['thumnail']['name'];
                    }
                    $update = $get_data ->
                  update_product($_POST['name'], $_POST['price'] ,$picture ,
                  $_POST['detail'] , $_POST['review'] , $_POST['delivery'] ,
                  $_POST['amount'] , $_POST['status'] , $_POST['title'] , $_POST['color'] , $_POST['price-sale'] , $_GET["update_product"]);
                   if($update){
