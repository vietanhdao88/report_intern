    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">List Product</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php 
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $se_fruit['id']?></td>
                                            <td><?php echo $se_fruit['name']?></td>
                                            <td><?php echo $se_fruit['price']?></td>
                                            <td><img src="../uploads/<?php echo $se_fruit['thumnail']?>" alt="" width="40px" height="40px" style="border-radius:100rem;"></td>
                                            <td><?php echo $se_fruit['detail']?></td>
                                            <td><?php echo $se_fruit['review']?></td>
                                            <td><?php echo $se_fruit['delivery']?></td>
                                            <td><?php echo $se_fruit['amount']?></td>
                                            <td><?php echo $se_fruit['status']?></td>
                                            <td><?php echo $se_fruit['title']?></td>
                                            <td><?php echo $se_fruit['colors']?></td>
                                            <td><?php echo $se_fruit['price_sale']?></td>
                                            <td><a href="delete_all.php?del_product=<?php echo $se_fruit['id'] ?>"  onclick="return(confirm('Bạn có chắc chắn muốn xóa'))" style="display: flex;align-items: center;justify-content: center;">
                                            ...
                                            <td><a href="update_product.php?update_product=<?php echo $se_fruit['id'] ?>" style="display: flex;align-items: center;justify-content: center;">
