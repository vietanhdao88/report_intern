    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div id="page-inner">
          <div class="row">
            <div class="col-md-12">
              <h1 class="page-head-line">Add brand</h1>
            </div>
          </div>
          <!-- /. ROW  -->
          <div class="row">
            <div class="col-md-12 col-sm-6 col-xs-12">
              <div class="panel panel-info">
                <div class="panel-heading">Thêm thương hiệu tại đây</div>
                <div class="panel-body">
                  ...
                  if(isset($_POST['btn-add'])){
                    ...
                    $insert = $get_data -> insert_brand($_POST['name'] , $_FILES['image']['name']);
                  if($insert){ 
                   echo "<script>alert('Thêm thương hiệu thành công')
                   window.location ='brand.php'</script>";
                   }else{ echo
